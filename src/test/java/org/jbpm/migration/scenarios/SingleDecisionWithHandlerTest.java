...
import org.jbpm.migration.tools.jpdl.handlers.DefaultDecisionHandler;
...
/**
 * Scenario containing single decision node with handler.
 * 
 */
public class SingleDecisionWithHandlerTest extends MigrationTestWrapper {
    public static final String definition = 
            "org/jbpm/migration/scenarios/singleDecisionWithHandler/processdefinition.xml";
    ...
    public void testJpdl() {
        ...
        DefaultDecisionHandler.setLeavingTransition("to-end-state1");
